...
if "__main__" == __name__:
    ...
    print(f"El área de la figura es de {rectangulo.compute_area()} unidades cuadradas")
    print(f"El perímetro de la figura es de {rectangulo.compute_perimeter()} unidades")
